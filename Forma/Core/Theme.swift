...
extension Color {
    static let formaBackground = Color(UIColor.systemGroupedBackground)
    static let formaCard       = Color(UIColor.secondarySystemBackground)
    static let formaAccent     = Color(red: 0.20, green: 0.44, blue: 0.90) // muted blue
